...
{/* Informações do projeto - Layout redesenhado */}
  ...
  <div className={styles.projectInfoContent}>
    <div className={styles.projectDescription}>
      ...
      <div className={styles.projectChallenges}>
        <h3 className={styles.challengesHeading}>Utmaningar</h3>
        <p>{project.challenges}</p>
      </div>

      <div className={styles.projectSolution}>
        <h3 className={styles.solutionHeading}>Lösning</h3>
  ...
  <div className={styles.galleryContainer}>
    {filteredMedia.map((item, index) => (
      <div 
        ...
        style={{'--item-index': index}} // Para animação sequencial
      >
